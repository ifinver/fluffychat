...
class L10n {
  ...
  String badServerLoginTypesException(
      Object serverVersions, Object supportedVersions) {
    return Intl.message(
      'The homeserver supports the login types:\n$serverVersions\nBut this app supports only:\n$supportedVersions',
      name: 'badServerLoginTypesException',
      desc: '',
      args: [serverVersions, supportedVersions],
    );
  }
  ...
  String badServerVersionsException(
    ...
    return Intl.message(
      'The homeserver supports the Spec versions:\n$serverVersions\nBut this app supports only $supportedVersions',
      name: 'badServerVersionsException',
      desc: '',
      args: [serverVersions, supportedVersions],
    );
  }
  ...
  String get chatDescriptionHasBeenChanged {
    return Intl.message(
      'Chat description changed',
      name: 'chatDescriptionHasBeenChanged',
      desc: '',
      args: [],
    );
  }
  ...
  String inviteContactToGroupQuestion(Object contact, Object groupName) {
    return Intl.message(
      'Do you want to invite $contact to the chat "$groupName"?',
      name: 'inviteContactToGroupQuestion',
      desc: '',
      args: [contact, groupName],
    );
  }
  ...
  /// `register to {homeserver}`
  String registerTo(Object homeserver) {
    return Intl.message(
      'register to $homeserver',
      name: 'registerTo',
      desc: '',
  ...
  String get pleaseTryAgainLaterOrChooseDifferentServer {
    return Intl.message(
      'Please try again later or choose a different server.',
      name: 'pleaseTryAgainLaterOrChooseDifferentServer',
      desc: '',
      args: [],
    );
  }
