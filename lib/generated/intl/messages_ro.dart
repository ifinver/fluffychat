...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(serverVersions, supportedVersions) =>
      "Homeserver-ul suportă următoarele feluri de login:\n${serverVersions}\nDar această aplicație suportă numai:\n${supportedVersions}";

  static String m5(serverVersions, supportedVersions) =>
      "Homeserver-ul suportă versiunele de Spec următoare:\n${serverVersions}\nDar această aplicație suportă numai ${supportedVersions}";

  static String m6(username, targetName) =>
      "${username} a interzis pe ${targetName}";

  static String m7(uri) => "Nu se poate deschide URI-ul ${uri}";

  static String m8(username) => "${username} a schimbat poza conversați";
  ...
  static String m11(username) => "${username} a schimbat permisiunile chatului";
  ...
  static String m17(username) => "${username} a schimbat regulile de alăturare";

  static String m18(username, joinRules) =>
      "${username} a schimbat regulile de alăturare la: ${joinRules}";

  static String m19(username) => "${username} s-a schimbat avatarul";

  static String m20(username) => "${username} a schimbat pseudonimele camerei";

  static String m21(username) => "${username} a schimbat linkul de invitație";

  static String m22(command) => "${command} nu este o comandă.";

  static String m23(error) => "Dezcriptarea mesajului a eșuat: ${error}";

  static String m24(count) => "${count} fișiere";

  static String m25(count) => "${count} participanți";

  static String m26(username) => "💬${username} a creat chatul";

  static String m27(senderName) => "${senderName} vă îmbrățișează";
  ...
  static String m31(senderName) => "${senderName} a terminat apelul";

  static String m32(error) => "Obținerea locației a eșuat: ${error}";

  static String m33(path) => "Fișierul a fost salvat la ${path}";

  static String m34(senderName) => "${senderName} v-a trimis ochi googly";

  static String m35(displayname) => "Grup cu ${displayname}";

  static String m36(username, targetName) =>
      "${username} a retras invitația pentru ${targetName}";

  static String m37(senderName) => "${senderName} vă îmbrățișează";

  static String m38(groupName) => "Invitați contact la ${groupName}";
  ...
  static String m42(username) => "👋${username} a intrat în chat";
  ...
  static String m46(count) => "Încărcați încă mai ${count} participanți";

  static String m47(homeserver) => "Conectați-vă la ${homeserver}";

  static String m48(server1, server2) =>
      "${server1} nu este server matrix, înlocuiți cu ${server2}?";

  static String m49(number) => "${number} chaturi";

  static String m50(count) => "${count} utilizatori tastează…";

  static String m51(fileName) => "Redați ${fileName}";

  static String m52(min) => "Vă rugăm să alegeți cel puțin ${min} caractere.";

  static String m53(sender, reaction) =>
      "${sender} a reacționat cu ${reaction}";

  static String m54(username) => "${username} a redactat un eveniment";

  static String m57(username) => "${username} a respins invitația";

  static String m58(username) => "Eliminat de ${username}";

  static String m60(username) => "Văzut de ${username}";
  ...
  static String m63(username) => "📁${username} a trimis un fișier";

  static String m64(username) => "🖼️ ${username} a trimis o poză";

  static String m65(username) => "😊 ${username} a trimis un sticker";

  static String m66(username) => "🎥${username} a trimis un video";

  static String m67(username) => "🎤${username} a trimis audio";

  static String m68(senderName) => "${senderName} a trimis informație de apel";

  static String m69(username) => "${username} sa partajat locația";

  static String m71(senderName) => "${senderName} a început un apel";

  static String m72(date, body) => "Story de ${date}:\n${body}";

  static String m73(mxid) => "ID-ul ar trebuii să fie ${mxid}";

  static String m74(number) => "Schimbați la contul ${number}";
  ...
  static String m79(username) => "${username} tastează…";

  static String m80(username) => "🚪${username} a plecat din chat";
  ...
  static String m83(oldDisplayName) => "Chat gol (a fost ${oldDisplayName})";

  static String m84(user) => "Ați interzis pe ${user}";

  static String m85(user) => "Ați retras invitația pentru ${user}";

  static String m86(user) => "📩Ați fost invitat de ${user}";

  static String m87(user) => "📩Ați invitat pe ${user}";

  static String m88(user) => "👞Ați dat afară pe ${user}";

  static String m89(user) => "🙅Ați dat afară și interzis pe ${user}";

  static String m90(user) => "Ați ridicat interzicerea lui ${user}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "continueWith": MessageLookupByLibrary.simpleMessage("Continuați cu:"),
        "copiedToClipboard":
        ...
        "signInWithPassword":
            MessageLookupByLibrary.simpleMessage("Conectați-vă cu parolă"),
