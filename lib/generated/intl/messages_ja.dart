...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(serverVersions, supportedVersions) =>
      "ホームサーバーでサポートされているバージョン：\n${serverVersions}\nアプリでは${supportedVersions}しかサポートされていません";

  static String m6(username, targetName) => "${username}が${targetName}をBANしました";

  static String m7(uri) => "URIが開けません ${uri}";

  static String m8(username) => "${username}がチャットアバターを変更しました";
  ...
  static String m11(username) => "${username}がチャットの権限を変更しました";

  static String m12(username, displayname) =>
      "${username}が表示名を「${displayname}」に変更しました";

  static String m13(username) => "${username}がゲストのアクセスルールを変更しました";

  static String m14(username, rules) =>
      "${username}がゲストのアクセスルールを${rules}に変更しました";

  static String m15(username) => "${username}が履歴の表示設定を変更しました";

  static String m16(username, rules) => "${username}が履歴の表示設定を${rules}に変更しました";

  static String m17(username) => "${username}が参加ルールを変更しました";

  static String m18(username, joinRules) =>
      "${username}が参加ルールを${joinRules}に変更しました";

  static String m19(username) => "${username}がアバターを変更しました";

  static String m20(username) => "${username}が部屋のエイリアスを変更しました";

  static String m21(username) => "${username}が招待リンクを変更しました";

  static String m22(command) => "${command} はコマンドではありません。";

  static String m23(error) => "メッセージを解読できませんでした: ${error}";

  static String m24(count) => "${count}個のファイル";

  static String m25(count) => "${count}名の参加者";

  static String m26(username) => "💬 ${username}がチャットを作成しました";
  ...
  static String m31(senderName) => "${senderName}は通話を切断しました";

  static String m32(error) => "位置情報の取得中にエラーが発生しました: ${error}";

  static String m35(displayname) => "${displayname}とグループを作成する";

  static String m36(username, targetName) =>
      "${targetName}の招待を${username}が取り下げました";

  static String m38(groupName) => "連絡先から${groupName}に招待する";
  ...
  static String m42(username) => "👋 ${username} がチャットに参加しました";
  ...
  static String m45(localizedTimeShort) => "最終アクティブ: ${localizedTimeShort}";

  static String m46(count) => "あと${count}名参加者を読み込む";

  static String m47(homeserver) => "${homeserver}にログインする";

  static String m48(server1, server2) =>
      "${server1} はMatrixのサーバーではありません。代わりに ${server2} を使用しますか?";

  static String m49(number) => "${number} チャット";

  static String m50(count) => "${count}人が入力中…";

  static String m51(fileName) => "${fileName}を再生する";

  static String m52(min) => "少なくとも${min}文字を選択してください。";

  static String m53(sender, reaction) => "${sender} が ${reaction} で反応しました";

  static String m54(username) => "${username}がイベントを編集しました";

  static String m57(username) => "${username}は招待を拒否しました";

  static String m58(username) => "${username}によって削除されました";

  static String m60(username) => "${username}が既読";

  static String m61(username, count) =>
      "${Intl.plural(count, other: '${username}と他${count}名が既読')}";

  static String m62(username, username2) => "${username}と${username2}が既読";

  static String m63(username) => "📁 ${username}はファイルを送信しました";

  static String m64(username) => "🖼️ ${username}は画像を送信しました";

  static String m65(username) => "😊 ${username}はステッカーを送信しました";

  static String m66(username) => "🎥 ${username}は動画を送信しました";

  static String m67(username) => "🎤 ${username}は音声を送信しました";

  static String m68(senderName) => "${senderName}は通話情報を送信しました";

  static String m69(username) => "${username}は現在地を共有しました";

  static String m71(senderName) => "${senderName}は通話を開始しました";

  static String m72(date, body) => "${date}からのストーリー:\n${body}";

  static String m74(number) => "アカウント ${number} に切り替える";
  ...
  static String m77(username, count) => "${username}と他${count}名が入力しています…";

  static String m78(username, username2) => "${username}と${username2}が入力しています…";

  static String m79(username) => "${username}が入力しています…";

  static String m80(username) => "🚪 ${username}はチャットから退室しました";

  static String m81(username, type) => "${username}は${type}イベントを送信しました";

  static String m82(size) => "ビデオ (${size})";

  static String m83(oldDisplayName) => "空のチャット (以前は ${oldDisplayName})";

  static String m84(user) => "${user} を禁止しました";

  static String m85(user) => "${user} への招待を取り下げました";

  static String m86(user) => "📩 ${user} から招待されました";

  static String m87(user) => "📩 ${user} を招待しました";

  static String m88(user) => "👞 ${user} をキックしました";

  static String m89(user) => "🙅 ${user} をキックしてブロックしました";

  static String m90(user) => "${user} の禁止を解除しました";
