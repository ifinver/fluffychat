...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(serverVersions, supportedVersions) =>
      "De homeserver ondersteunt de login types:\n${serverVersions}\nMaar deze app ondersteunt alleen:\n${supportedVersions}";

  static String m5(serverVersions, supportedVersions) =>
      "De homeserver ondersteunt de Spec-versies:\n${serverVersions}\nMaar deze app ondersteunt alleen ${supportedVersions}";

  static String m6(username, targetName) => "${username} verbant ${targetName}";

  static String m7(uri) => "Kan de URI ${uri} niet openen";

  static String m8(username) => "${username} heeft de chatavatar gewijzigd";
  ...
  static String m11(username) => "${username} heeft de chatrechten gewijzigd";
  ...
  static String m19(username) => "${username}\'s avatar is gewijzigd";

  static String m20(username) => "${username} heeft de kameraliassen gewijzigd";

  static String m21(username) =>
      "${username} heeft de uitnodigingslink gewijzigd";

  static String m22(command) => "${command} is geen opdracht.";

  static String m23(error) => "Kan het bericht niet ontsleutelen: ${error}";

  static String m24(count) => "${count} bestanden";

  static String m25(count) => "${count} personen";

  static String m26(username) => "💬 ${username} heeft de chat gemaakt";

  static String m27(senderName) => "${senderName} knuffelt je";
  ...
  static String m31(senderName) => "${senderName} heeft het gesprek beëindigd";

  static String m32(error) => "Locatie ophalen fout: ${error}";

  static String m33(path) => "Het bestand is opgeslagen op ${path}";

  static String m34(senderName) => "${senderName} stuurt je wiebelogen";

  static String m35(displayname) => "Groep met ${displayname}";

  static String m36(username, targetName) =>
      "${username} heeft de uitnodiging voor ${targetName} ingetrokken";

  static String m37(senderName) => "${senderName} omhelst je";

  static String m38(groupName) => "Contact voor ${groupName} uitnodigen";
  ...
  static String m42(username) => "👋 ${username} is toegetreden tot de chat";
  ...
  static String m46(count) => "Laad nog ${count} personen";

  static String m47(homeserver) => "Inloggen bij ${homeserver}";
  ...
  static String m50(count) => "${count} personen typen…";

  static String m51(fileName) => "Speel ${fileName}";

  static String m52(min) => "Kies een wachtwoord met minimaal ${min} tekens.";

  static String m53(sender, reaction) => "${sender} reageerde met ${reaction}";

  static String m54(username) => "${username} heeft een event verwijderd";

  static String m57(username) => "${username} heeft de uitnodiging afgewezen";

  static String m58(username) => "Verwijderd door ${username}";

  static String m59(path) => "Emote-pack opgeslagen op ${path}!";

  static String m60(username) => "Gezien door ${username}";
  ...
  static String m63(username) => "📁 ${username} heeft een bestand verzonden";

  static String m64(username) =>
      "🖼️ ${username} heeft een afbeelding verzonden";

  static String m65(username) => "😊 ${username} heeft een sticker verzonden";

  static String m66(username) => "🎥 ${username} heeft een video verzonden";

  static String m67(username) => "🎤 ${username} heeft een audio verzonden";

  static String m68(senderName) =>
      "${senderName} heeft oproepgegevens verzonden";

  static String m69(username) => "${username} heeft deze locatie gedeeld";

  static String m70(provider) => "Aanmelden met ${provider}";

  static String m71(senderName) => "${senderName} heeft een gesprek gestart";

  static String m72(date, body) => "Verhaal van ${date}:\n${body}";

  static String m73(mxid) => "Dit moet ${mxid} zijn";

  static String m74(number) => "Naar account ${number} overschakelen";
  ...
  static String m79(username) => "${username} is aan het typen …";

  static String m80(username) => "🚪 ${username} is vertrokken uit de chat";
  ...
  static String m83(oldDisplayName) => "Lege chat (was ${oldDisplayName})";

  static String m84(user) => "Je hebt ${user} verbannen";

  static String m85(user) => "Je hebt de uitnodiging voor ${user} ingetrokken";

  static String m86(user) => "📩 Je bent uitgenodigd door ${user}";

  static String m87(user) => "📩 Je hebt ${user} uitgenodigd";

  static String m88(user) => "👞 Je hebt ${user} weggestuurd";

  static String m89(user) => "🙅 Je hebt weggestuurd en verbannen ${user}";

  static String m90(user) => "Je hebt de ban op ${user} opgeheven";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "allRooms": MessageLookupByLibrary.simpleMessage("Alle groepschats"),
        ...
        "continueWith": MessageLookupByLibrary.simpleMessage("Ga verder met:"),
        "copiedToClipboard":
        ...
        "exportEmotePack": MessageLookupByLibrary.simpleMessage(
            "Emote-pakket als zip exporteren"),
        "extremeOffensive":
        ...
        "importEmojis":
            MessageLookupByLibrary.simpleMessage("Emoji\'s importeren"),
        "importFromZipFile":
            MessageLookupByLibrary.simpleMessage("Uit zip-bestand importeren"),
        "importNow": MessageLookupByLibrary.simpleMessage("Nu importeren"),
        "importZipFile":
            MessageLookupByLibrary.simpleMessage("Zip-bestand importeren"),
        ...
        "notAnImage":
            MessageLookupByLibrary.simpleMessage("Geen afbeeldingsbestand."),
        ...
        "replace": MessageLookupByLibrary.simpleMessage("Vervang"),
        ...
        "sendTypingNotifications":
            MessageLookupByLibrary.simpleMessage("Typemeldingen verzenden"),
        ...
        "signInWith": m70,
        "signInWithPassword":
            MessageLookupByLibrary.simpleMessage("Aanmelden met wachtwoord"),
