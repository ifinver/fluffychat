...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(serverVersions, supportedVersions) =>
      "Домашній сервер підтримує такі версії специфікацій:\n${serverVersions}\nАле цей застосунок підтримує лише ${supportedVersions}";

  static String m6(username, targetName) => "${username} блокує ${targetName}";

  static String m7(uri) => "Не вдалося відкрити URI ${uri}";

  static String m8(username) => "${username} змінює аватар бесіди";
  ...
  static String m11(username) => "${username} змінює права доступу бесіди";
  ...
  static String m15(username) => "${username} змінює видимість історії";

  static String m16(username, rules) =>
      "${username} змінює видимість історії на: ${rules}";

  static String m17(username) => "${username} змінює правила приєднання";

  static String m18(username, joinRules) =>
      "${username} змінює правила приєднання на: ${joinRules}";

  static String m19(username) => "${username} змінює аватар";

  static String m20(username) => "${username} змінює псевдоніми кімнати";

  static String m21(username) => "${username} змінює посилання для запрошення";

  static String m22(command) => "${command} не є командою.";

  static String m23(error) => "Помилка розшифрування повідомлення: ${error}";

  static String m24(count) => "${count} файлів";

  static String m25(count) => "Учасників: ${count}";

  static String m26(username) => "💬 ${username} створює бесіду";

  static String m27(senderName) => "${senderName} пригортається до вас";
  ...
  static String m31(senderName) => "${senderName} завершує виклик";

  static String m32(error) =>
      "Помилка під час отримання розташування: ${error}";

  static String m33(path) => "Файл збережено в ${path}";

  static String m34(senderName) => "${senderName} надсилає вам гугл-очі";

  static String m35(displayname) => "Група з ${displayname}";

  static String m36(username, targetName) =>
      "${username} відкликає запрошення для ${targetName}";

  static String m37(senderName) => "${senderName} обіймає вас";

  static String m38(groupName) => "Запросити контакт до ${groupName}";

  static String m39(contact, groupName) =>
      "Хочете запросити ${contact} до бесіди \"${groupName}\"?";
  ...
  static String m42(username) => "👋 ${username} приєднується до бесіди";
  ...
  static String m46(count) => "Завантажити ще ${count} учасників";

  static String m47(homeserver) => "Увійти до ${homeserver}";

  static String m48(server1, server2) =>
      "${server1} не є сервером matrix, використовувати ${server2} натомість?";

  static String m49(number) => "${number} бесід";

  static String m50(count) => "${count} користувачів пишуть…";

  static String m51(fileName) => "Відтворити ${fileName}";

  static String m52(min) => "Виберіть принаймні ${min} символів.";

  static String m53(sender, reaction) => "${sender} реагує з ${reaction}";

  static String m54(username) => "${username} змінює подію";

  static String m57(username) => "${username} відхиляє запрошення";

  static String m58(username) => "Вилучено користувачем ${username}";

  static String m59(path) => "Набір емотиконів збережено в ${path}!";

  static String m60(username) => "Переглянуто ${username}";
  ...
  static String m63(username) => "📁 ${username} надсилає файл";

  static String m64(username) => "🖼️ ${username} надсилає зображення";

  static String m65(username) => "😊 ${username} надсилає наліпку";

  static String m66(username) => "🎥 ${username} надсилає відео";

  static String m67(username) => "🎤 ${username} надсилає аудіо";

  static String m68(senderName) =>
      "${senderName} надсилає відомості про виклик";

  static String m69(username) => "${username} ділиться своїм місцеперебуванням";

  static String m70(provider) => "Увійти через ${provider}";

  static String m71(senderName) => "${senderName} розпочинає виклик";

  static String m72(date, body) => "Історія за ${date}: \n${body}";

  static String m73(mxid) => "Це має бути ${mxid}";

  static String m74(number) => "Перемкнутися на обліковий запис ${number}";
  ...
  static String m77(username, count) => "${username} та ${count} інших пишуть…";

  static String m78(username, username2) =>
      "${username} і ${username2} пишуть…";

  static String m79(username) => "${username} пише…";

  static String m80(username) => "🚪 ${username} виходить з бесіди";

  static String m81(username, type) => "${username} надсилає подію ${type}";

  static String m82(size) => "Відео (${size})";

  static String m83(oldDisplayName) =>
      "Порожня бесіда (раніше ${oldDisplayName})";

  static String m84(user) => "Ви заблокували ${user}";

  static String m85(user) => "Ви відкликали запрошення для ${user}";

  static String m86(user) => "📩 Ви були запрошені ${user}";

  static String m87(user) => "📩 Ви запросили ${user}";

  static String m88(user) => "👞 Ви вилучили ${user}";

  static String m89(user) => "🙅 Ви вилучили й заблокували ${user}";

  static String m90(user) => "Ви розблокували ${user}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "continueWith":
            MessageLookupByLibrary.simpleMessage("Продовжити за допомогою:"),
        "copiedToClipboard":
        ...
        "createGroup": MessageLookupByLibrary.simpleMessage("Створити групу"),
        ...
        "exportEmotePack": MessageLookupByLibrary.simpleMessage(
            "Експортувати набір емотиконів у форматі .zip"),
        "extremeOffensive":
        ...
        "importEmojis": MessageLookupByLibrary.simpleMessage("Імпорт емодзі"),
        "importFromZipFile":
            MessageLookupByLibrary.simpleMessage("Імпорт з файлу .zip"),
        "importNow": MessageLookupByLibrary.simpleMessage("Імпортувати зараз"),
        "importZipFile":
            MessageLookupByLibrary.simpleMessage("Імпортувати файл .zip"),
        ...
        "notAnImage":
            MessageLookupByLibrary.simpleMessage("Не файл зображення."),
        ...
        "sendTypingNotifications": MessageLookupByLibrary.simpleMessage(
            "Надсилати сповіщення про ввід тексту"),
        ...
        "signInWith": m70,
        "signInWithPassword":
            MessageLookupByLibrary.simpleMessage("Увійти за допомогою пароля"),
