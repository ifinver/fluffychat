...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(username, targetName) => "${username}이 ${targetName} 밴함";

  static String m7(uri) => "URI ${uri}를 열 수 없습니다";

  static String m8(username) => "${username}이 채팅 아바타 바꿈";
  ...
  static String m11(username) => "${username}이 채팅 권한을 바꿈";

  static String m12(username, displayname) =>
      "${username}이 닉네임을 \'${displayname}\' 으로 바꿈";

  static String m13(username) => "${username}이 게스트 접근 규칙을 변경함";

  static String m14(username, rules) =>
      "${username}이 게스트 접근 규칙을 ${rules} 로 변경함";

  static String m15(username) => "${username}이 대화 기록 설정을 변경함";

  static String m16(username, rules) => "${username}이 대화 기록 설정을 ${rules} 로 바꿈";

  static String m17(username) => "${username}이 참가 규칙을 바꿈";

  static String m18(username, joinRules) =>
      "${username}이 참가 규칙을 ${joinRules} 로 바꿈";

  static String m19(username) => "${username}이 자신의 아바타를 바꿈";

  static String m20(username) => "${username}이 방 별명을 바꿈";

  static String m21(username) => "${username}이 초대 링크 바꿈";

  static String m22(command) => "${command} 는 명령어가 아닙니다.";

  static String m23(error) => "메시지 복호화할 수 없음: ${error}";

  static String m25(count) => "${count} 참여자";

  static String m26(username) => "💬 ${username}님이 채팅을 생성함";
  ...
  static String m31(senderName) => "${senderName} 이 통화를 종료했습니다";

  static String m32(error) => "위치 얻는 중 오류: ${error}";

  static String m34(senderName) => "${senderName} 님이 왕눈이 눈알을 보냈습니다";

  static String m35(displayname) => "${displayname} 과의 그룹";

  static String m36(username, targetName) =>
      "${username}이 ${targetName}에 대한 초대를 철회함";

  static String m38(groupName) => "연락처 ${groupName} 에 초대";
  ...
  static String m42(username) => "👋 ${username}님이 채팅에 참가함";
  ...
  static String m45(localizedTimeShort) => "마지막 활동: ${localizedTimeShort}";

  static String m46(count) => "${count}명의 참가자 더 표시";

  static String m47(homeserver) => "${homeserver} 에 로그인";

  static String m48(server1, server2) =>
      "${server1}은 matrix 서버가 아닙니다, ${server2}를 대신 사용할까요?";

  static String m50(count) => "${count}명이 입력 중…";

  static String m51(fileName) => "${fileName} 재생";

  static String m52(min) => "최소 ${min}자를 선택하세요.";

  static String m53(sender, reaction) => "${sender}가 ${reaction}로 반응함";

  static String m54(username) => "${username}이 이벤트를 지움";

  static String m57(username) => "${username}이 초대를 거절함";

  static String m58(username) => "${username}에 의해 지워짐";

  static String m60(username) => "${username}이 읽음";

  static String m61(username, count) =>
      "${Intl.plural(count, other: '${username}과 이외 ${count}명이 읽음')}";

  static String m62(username, username2) => "${username}, ${username2}가 읽음";

  static String m63(username) => "${username}이 파일 보냄";

  static String m64(username) => "${username}이 사진 보냄";

  static String m65(username) => "${username}이 스티커 보냄";

  static String m66(username) => "${username}이 영상 보냄";

  static String m67(username) => "${username}이 오디오 보냄";

  static String m68(senderName) => "${senderName} 이 통화 정보 보냄";

  static String m69(username) => "${username}이 위치 공유함";

  static String m71(senderName) => "${senderName} 가 통화 시작함";

  static String m72(date, body) => "${date}의 스토리:\n${body}";

  static String m75(username, targetName) => "${username}이 ${targetName} 밴 해제함";

  static String m76(unreadCount) =>
      "${Intl.plural(unreadCount, one: '읽지 않은 채팅 1', other: '${unreadCount} 개')}";

  static String m77(username, count) => "${username}과 ${count}명이 입력 중…";

  static String m78(username, username2) => "${username}과 ${username2}가 입력 중…";

  static String m79(username) => "${username}이 입력 중…";

  static String m80(username) => "${username}이 채팅을 나감";

  static String m81(username, type) => "${username}이 ${type} 이벤트 보냄";

  static String m82(size) => "영상 (${size})";
