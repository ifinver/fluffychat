...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(uri) => "無法打開URI ${uri}";

  static String m8(username) => "${username}變更了對話頭貼";

  static String m9(username, description) =>
      "${username}變更了對話介紹為：「${description}」";

  static String m10(username, chatname) => "${username}變更了暱稱為：「${chatname}」";

  static String m11(username) => "${username}變更了對話權限";

  static String m12(username, displayname) =>
      "${username} 變更了顯示名稱為：「${displayname}」";

  static String m13(username) => "${username}變更了訪客訪問規則";

  static String m14(username, rules) => "${username}變更了訪客訪問規則為：${rules}";

  static String m15(username) => "${username}變更了歷史記錄觀察狀態";

  static String m16(username, rules) => "${username}變更了歷史紀錄觀察狀態到：${rules}";

  static String m17(username) => "${username}變更了加入的規則";

  static String m18(username, joinRules) => "${username}變更了加入的規則為：${joinRules}";

  static String m19(username) => "${username}變更了頭貼";

  static String m20(username) => "${username}變更了聊天室名";

  static String m21(username) => "${username}變更了邀請連結";

  static String m23(error) => "不能解密訊息：${error}";

  static String m25(count) => "${count}個參與者";

  static String m26(username) => "${username}建立了聊天室";
  ...
  static String m31(senderName) => "${senderName}結束了通話";

  static String m35(displayname) => "名稱為${displayname}的群組";

  static String m36(username, targetName) => "${username}收回了對${targetName}的邀請";

  static String m38(groupName) => "邀請聯絡人到${groupName}";

  static String m40(username, link) =>
      "${username}邀請您使用FluffyChat\n1. 安裝FluffyChat：https://fluffychat.im\n2. 登入或註冊\n3. 打開該邀請網址：${link}";

  static String m41(username, targetName) => "${username}邀請了${targetName}";

  static String m42(username) => "${username}加入了聊天室";

  static String m43(username, targetName) => "${username}踢了${targetName}";

  static String m44(username, targetName) => "${username}踢了${targetName}並將其封禁";

  static String m45(localizedTimeShort) => "最後活動時間：${localizedTimeShort}";

  static String m46(count) => "載入${count}個更多的參與者";

  static String m47(homeserver) => "登入${homeserver}";

  static String m50(count) => "${count}個人正在輸入…";

  static String m51(fileName) => "播放${fileName}";

  static String m52(min) => "請至少輸入 ${min} 个字元。";

  static String m54(username) => "${username}編輯了一個事件";

  static String m57(username) => "${username}拒絕了邀請";

  static String m58(username) => "被${username}移除";

  static String m60(username) => "${username}已讀";

  static String m61(username, count) =>
      "${Intl.plural(count, other: '${username}和其他${count}個人已讀')}";

  static String m62(username, username2) => "${username}和${username2}已讀";

  static String m63(username) => "${username}傳送了一個文件";

  static String m64(username) => "${username}傳送了一張圖片";

  static String m65(username) => "${username} 傳送了貼圖";

  static String m66(username) => "${username} 傳送了影片";

  static String m67(username) => "${username}傳送了一個音訊";

  static String m68(senderName) => "${senderName} 傳送了通話資訊";

  static String m69(username) => "${username} 分享了位置";

  static String m71(senderName) => "${senderName}開始了通話";

  static String m75(username, targetName) => "${username}解除封禁了${targetName}";

  static String m76(unreadCount) =>
      "${Intl.plural(unreadCount, one: '1 unread chat', other: '${unreadCount} 個未讀聊天室')}";

  static String m77(username, count) => "${username}和其他${count}個人正在輸入…";

  static String m78(username, username2) => "${username}和${username2}正在輸入…";

  static String m79(username) => "${username}正在輸入…";

  static String m80(username) => "${username}離開了聊天室";

  static String m81(username, type) => "${username}傳送了一個${type}事件";
