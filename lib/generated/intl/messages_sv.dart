...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(username, targetName) => "${username} bannlös ${targetName}";

  static String m7(uri) => "Kan inte öppna URL ${uri}";

  static String m8(username) => "${username} ändrade sin chatt-avatar";
  ...
  static String m11(username) => "${username} ändrade chatt-rättigheterna";

  static String m12(username, displayname) =>
      "${username} ändrade visningsnamnet till: \'${displayname}\'";

  static String m13(username) => "${username} ändrade reglerna för gästaccess";

  static String m14(username, rules) =>
      "${username} ändrade reglerna för gästaccess till: ${rules}";

  static String m15(username) => "${username} ändrade historikens synlighet";

  static String m16(username, rules) =>
      "${username} ändrade historikens synlighet till: ${rules}";

  static String m17(username) => "${username} ändrade anslutningsreglerna";

  static String m18(username, joinRules) =>
      "${username} ändrade anslutningsreglerna till ${joinRules}";

  static String m19(username) => "${username} ändrade sin avatar";

  static String m20(username) => "${username} ändrade rummets alias";

  static String m21(username) => "${username} ändrade inbjudningslänken";

  static String m22(command) => "${command} är inte ett kommando.";

  static String m23(error) => "Kunde ej avkoda meddelande: ${error}";

  static String m24(count) => "${count} filer";

  static String m25(count) => "${count} deltagare";

  static String m26(username) => "💬 ${username} skapade chatten";

  static String m27(senderName) => "${senderName} omfamnar dig";
  ...
  static String m31(senderName) => "${senderName} avslutade samtalet";

  static String m32(error) => "Fel vid erhållande av plats: ${error}";

  static String m33(path) => "Filen har sparats i ${path}";

  static String m34(senderName) => "${senderName} skickar dig googly ögon";

  static String m35(displayname) => "Gruppen med ${displayname}";

  static String m36(username, targetName) =>
      "${username} har tagit tillbaka inbjudan för ${targetName}";

  static String m37(senderName) => "${senderName} kramar dig";

  static String m38(groupName) => "Bjud in kontakt till ${groupName}";
  ...
  static String m42(username) => "👋 ${username} anslöt till chatten";
  ...
  static String m46(count) => "Ladda ${count} mer deltagare";

  static String m47(homeserver) => "Logga in till ${homeserver}";

  static String m48(server1, server2) =>
      "${server1} är inte en matrix server, använd ${server2} istället?";

  static String m49(number) => "${number} chattar";

  static String m50(count) => "${count} användare skriver…";

  static String m51(fileName) => "Spela ${fileName}";

  static String m52(min) => "Vänligen ange minst ${min} tecken.";

  static String m53(sender, reaction) => "${sender} reagerade med ${reaction}";

  static String m54(username) => "${username} redigerade en händelse";

  static String m57(username) => "${username} avböjde inbjudan";

  static String m58(username) => "Bortagen av ${username}";

  static String m60(username) => "Sedd av ${username}";
  ...
  static String m63(username) => "📁 ${username} skickade en fil";

  static String m64(username) => "🖼️ ${username} skickade en bild";

  static String m65(username) => "😊 ${username} skickade ett klistermärke";

  static String m66(username) => "🎥 ${username} skickade en video";

  static String m67(username) => "🎤 ${username} skickade ett ljudklipp";

  static String m68(senderName) => "${senderName} skickade samtalsinformation";

  static String m69(username) => "${username} delade sin position";

  static String m71(senderName) => "${senderName} startade ett samtal";

  static String m72(date, body) => "Berättelse från ${date}: \n${body}";

  static String m73(mxid) => "Detta bör vara ${mxid}";

  static String m74(number) => "Byt till konto ${number}";
  ...
  static String m80(username) => "🚪 ${username} lämnade chatten";
  ...
  static String m83(oldDisplayName) => "Tom chatt (var ${oldDisplayName})";

  static String m84(user) => "Du förbjöd ${user}";

  static String m85(user) => "Du har återkallat inbjudan till ${user}";

  static String m86(user) => "📩 Du har blivit inbjuden av ${user}";

  static String m87(user) => "📩 Du bjöd in ${user}";

  static String m88(user) => "👞 Du sparkade ut ${user}";

  static String m89(user) => "🙅 Du sparkade ut och förbjöd ${user}";

  static String m90(user) => "Du återkallade förbudet för ${user}";
