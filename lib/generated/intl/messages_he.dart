...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(serverVersions, supportedVersions) =>
      "שרת הבית תומך בגרסאות:\n${serverVersions}\nאבל האפליקציה הזו תומכת רק ב-${supportedVersions}";

  static String m6(username, targetName) => "${username} חסם את ${targetName}";

  static String m7(uri) => "לא ניתן לפתוח את ה-URI ${uri}";

  static String m8(username) => "${username} שינה את האווטאר של הצ\'אט";
  ...
  static String m11(username) => "${username} שינה את הרשאות הצ\'אט";

  static String m12(username, displayname) =>
      "${username} שינה את שם התצוגה שלו ל: \'${displayname}\'";

  static String m13(username) => "${username} שינה את כללי הגישה לאורחים";

  static String m14(username, rules) =>
      "${username} שינה את כללי הגישה לאורחים ל: ${rules}";

  static String m15(username) => "${username} שינה את נראות ההיסטוריה";

  static String m16(username, rules) =>
      "${username} שינה את נראות ההיסטוריה ל: ${rules}";

  static String m17(username) => "${username} שינה את כללי ההצטרפות";

  static String m18(username, joinRules) =>
      "${username} שינה את כללי ההצטרפות ל: ${joinRules}";

  static String m19(username) => "${username} שינה את האווטאר שלו";

  static String m20(username) => "${username} שינה את כינוי החדר";

  static String m21(username) => "${username} שינה את קישור ההזמנה";

  static String m22(command) => "${command} אינו פקודה.";

  static String m23(error) => "לא ניתן לפענח הודעה: ${error}";

  static String m25(count) => "${count} משתתפים";

  static String m26(username) => "${username} יצר את הצ\'אט";
  ...
  static String m31(senderName) => "${senderName} סיים את השיחה";

  static String m32(error) => "שגיאה בהשגת מיקום: ${error}";

  static String m35(displayname) => "קבוצה עם ${displayname}";

  static String m36(username, targetName) =>
      "${username} ביטל את ההזמנה עבור ${targetName}";

  static String m38(groupName) => "הזמן איש קשר אל ${groupName}";
  ...
  static String m42(username) => "${username} הצטרף לצ\'אט";

  static String m43(username, targetName) => "${username} בעט ב ${targetName}";
  ...
  static String m46(count) => "טען ${count} משתתפים נוספים";

  static String m47(homeserver) => "היכנס אל ${homeserver}";

  static String m48(server1, server2) =>
      "${server1} אינו שרת מטריקס, השתמש ב-${server2} במקום זאת?";

  static String m50(count) => "${count} משתמשים מקלידים…";

  static String m51(fileName) => "הפעל ${fileName}";

  static String m52(min) => "אנא כתוב לפחות ${min} תווים";
