...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m11(username) => "${username} sohbet izinlerini değiştirdi";
  ...
  static String m15(username) => "${username} geçmiş görünürlüğünü değiştirdi";

  static String m16(username, rules) =>
      "${username} geçmiş görünürlüğünü değiştirdi: ${rules}";

  static String m17(username) => "${username} katılım kurallarını değiştirdi";

  static String m18(username, joinRules) =>
      "${username} katılım kurallarını değiştirdi: ${joinRules}";

  static String m19(username) => "${username} avatarını değiştirdi";

  static String m20(username) => "${username} oda takma adlarını değiştirdi";

  static String m21(username) => "${username} davet bağlantısını değiştirdi";

  static String m22(command) => "${command} bir komut değil.";

  static String m23(error) => "Mesajın şifresi çözülemedi: ${error}";

  static String m24(count) => "${count} dosya";

  static String m25(count) => "${count} katılımcı";

  static String m26(username) => "💬 ${username} sohbeti oluşturdu";

  static String m27(senderName) => "${senderName} sizi kucaklıyor";
  ...
  static String m31(senderName) => "${senderName} aramayı sonlandırdı";

  static String m32(error) => "Konum alınırken hata oluştu: ${error}";

  static String m33(path) => "Dosya ${path} konumuna kaydedildi";

  static String m34(senderName) =>
      "${senderName} size şaşkın gözler gönderiyor";

  static String m35(displayname) => "${displayname} ile grup";

  static String m36(username, targetName) =>
      "${username}, ${targetName} için daveti geri çekti";

  static String m37(senderName) => "${senderName} size sarılıyor";

  static String m38(groupName) => "Kişiyi ${groupName} grubuna davet et";
  ...
  static String m42(username) => "👋 ${username} sohbete katıldı";
  ...
  static String m45(localizedTimeShort) => "Son görülen: ${localizedTimeShort}";

  static String m46(count) => "${count} katılımcı daha yükle";

  static String m47(homeserver) => "${homeserver} üzerinde oturum aç";

  static String m48(server1, server2) =>
      "${server1} matrix sunucusu değil, onun yerine ${server2} kullanılsın mı?";

  static String m49(number) => "${number} sohbet";

  static String m50(count) => "${count} kullanıcı yazıyor…";

  static String m51(fileName) => "${fileName} dosyasını oynat";

  static String m52(min) => "Lütfen en az ${min} karakter seçin.";

  static String m53(sender, reaction) =>
      "${sender}, ${reaction} ile tepki verdi";

  static String m54(username) => "${username} bir etkinliği düzenledi";

  static String m57(username) => "${username} daveti reddetti";

  static String m58(username) => "${username} tarafından kaldırıldı";

  static String m59(path) => "İfade paketi ${path} konumuna kaydedildi!";

  static String m60(username) => "${username} tarafından görüldü";
  ...
  static String m63(username) => "📁 ${username} bir dosya gönderdi";

  static String m64(username) => "🖼️ ${username} bir resim gönderdi";

  static String m65(username) => "😊 ${username} bir çıkartma gönderdi";

  static String m66(username) => "🎥 ${username} bir video gönderdi";

  static String m67(username) => "🎤 ${username} bir ses gönderdi";

  static String m68(senderName) => "${senderName} arama bilgilerini gönderdi";

  static String m69(username) => "${username} konumunu paylaştı";

  static String m70(provider) => "${provider} ile oturum aç";

  static String m71(senderName) => "${senderName} bir arama başlattı";

  static String m72(date, body) => "${date} tarihinden hikaye: \n${body}";

  static String m73(mxid) => "Bu ${mxid} olmalıdır";

  static String m74(number) => "${number}. hesaba geç";
  ...
  static String m79(username) => "${username} yazıyor…";

  static String m80(username) => "🚪 ${username} sohbetten ayrıldı";
  ...
  static String m83(oldDisplayName) => "Boş sohbet (${oldDisplayName} idi)";

  static String m84(user) => "${user} kullanıcısını yasakladınız";

  static String m85(user) => "${user} için daveti geri çektiniz";

  static String m86(user) => "📩 ${user} tarafından davet edildiniz";

  static String m87(user) => "📩 ${user} kullanıcısını davet ettiniz";

  static String m88(user) => "👞 ${user} kullanıcısını attınız";

  static String m89(user) => "🙅 ${user} kullanıcısını attınız ve yasakladınız";

  static String m90(user) => "${user} kullanıcısının yasağını kaldırdınız";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "allRooms": MessageLookupByLibrary.simpleMessage("Tüm Grup Sohbetleri"),
        ...
        "continueWith": MessageLookupByLibrary.simpleMessage("Devam et:"),
        "copiedToClipboard":
        ...
        "createGroup": MessageLookupByLibrary.simpleMessage("Grup oluştur"),
        ...
        "exportEmotePack": MessageLookupByLibrary.simpleMessage(
            "İfade paketini .zip olarak dışa aktar"),
        "extremeOffensive":
        ...
        "importEmojis":
            MessageLookupByLibrary.simpleMessage("İfadeleri İçe Aktar"),
        "importFromZipFile":
            MessageLookupByLibrary.simpleMessage(".zip dosyasından içe aktar"),
        "importNow": MessageLookupByLibrary.simpleMessage("Şimdi içe aktar"),
        "importZipFile":
            MessageLookupByLibrary.simpleMessage(".zip dosyasını içe aktar"),
        ...
        "messagesStyle": MessageLookupByLibrary.simpleMessage("Mesajlar:"),
        ...
        "notAnImage":
            MessageLookupByLibrary.simpleMessage("Bir resim dosyası değil."),
        ...
        "reportErrorDescription": MessageLookupByLibrary.simpleMessage(
            "Olamaz. Bir şeyler yanlış gitti. Lütfen daha sonra tekrar deneyin. İsterseniz hatayı geliştiricilere bildirebilirsiniz."),
        ...
        "sendTypingNotifications":
            MessageLookupByLibrary.simpleMessage("Yazma bildirimleri gönder"),
        ...
        "setColorTheme":
            MessageLookupByLibrary.simpleMessage("Renk temasını ayarla:"),
        "setCustomEmotes":
        ...
        "setTheme": MessageLookupByLibrary.simpleMessage("Temayı ayarla:"),
        "settings": MessageLookupByLibrary.simpleMessage("Ayarlar"),
        "share": MessageLookupByLibrary.simpleMessage("Paylaş"),
        "shareInviteLink":
            MessageLookupByLibrary.simpleMessage("Davet bağlantısını paylaş"),
        ...
        "signInWith": m70,
        "signInWithPassword":
            MessageLookupByLibrary.simpleMessage("Parola ile oturum aç"),
