...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(serverVersions, supportedVersions) =>
      "El servidor soporta las siguientes versiones de la especificación:\n${serverVersions}\npero esta aplicación sólo soporta las versiones ${supportedVersions}";

  static String m6(username, targetName) => "${username} vetó a ${targetName}";

  static String m7(uri) => "No puedo abrir el URI ${uri}";

  static String m8(username) => "${username} cambió el icono del chat";
  ...
  static String m11(username) => "${username} cambió los permisos del chat";
  ...
  static String m17(username) => "${username} cambió las reglas de ingreso";

  static String m18(username, joinRules) =>
      "${username} cambió las reglas de ingreso a ${joinRules}";

  static String m19(username) => "${username} cambió su imagen de perfil";

  static String m20(username) => "${username} cambió el alias de la sala";

  static String m21(username) => "${username} cambió el enlace de invitación";

  static String m22(command) => "${command} no es un comando.";

  static String m23(error) => "No se pudo descifrar el mensaje: ${error}";

  static String m25(count) => "${count} participantes";

  static String m26(username) => "💬${username} creó el chat";
  ...
  static String m31(senderName) => "${senderName} terminó la llamada";

  static String m32(error) => "Error al obtener la ubicación: ${error}";
  ...
  static String m38(groupName) => "Invitar contacto a ${groupName}";
  ...
  static String m42(username) => "👋${username} se unió al chat";

  static String m43(username, targetName) => "${username} echó a ${targetName}";
  ...
  static String m46(count) => "Mostrar ${count} participantes más";

  static String m47(homeserver) => "Iniciar sesión en ${homeserver}";

  static String m48(server1, server2) =>
      "${server1} no es un servidor matrix, usar ${server2} en su lugar?";

  static String m50(count) => "${count} usuarios están escribiendo…";

  static String m51(fileName) => "Reproducir ${fileName}";

  static String m52(min) => "Por favor elige al menos ${min} carácteres.";

  static String m54(username) => "${username} censuró un suceso";

  static String m57(username) => "${username} rechazó la invitación";
  ...
  static String m63(username) => "${username} envió un archivo";

  static String m64(username) => "${username} envió una imagen";

  static String m65(username) => "${username} envió un sticker";

  static String m66(username) => "${username} envió un video";

  static String m67(username) => "${username} envió un audio";

  static String m68(senderName) =>
      "${senderName} envió información de la llamada";

  static String m69(username) => "${username} compartió la ubicación";

  static String m71(senderName) => "${senderName} comenzó una llamada";
  ...
  static String m79(username) => "${username} está escribiendo…";

  static String m80(username) => "${username} abandonó el chat";

  static String m81(username, type) => "${username} envió un evento ${type}";

  static String m82(size) => "Video (${size})";

  static String m86(user) => "📩 Has sido invitado por ${user}";
