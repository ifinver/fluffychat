...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(serverVersions, supportedVersions) =>
      "Li hem-servitor supporta ti tipes de autentication:\n${serverVersions}\nMa ti-ci application supporta solmen:\n${supportedVersions}";
  ...
  static String m7(uri) => "Ne successat aperter li adresse ${uri}";
  ...
  static String m35(displayname) => "Gruppe con ${displayname}";
  ...
  static String m49(number) => "${number} conversationes";

  static String m51(fileName) => "Reproducter ${fileName}";

  static String m52(min) => "Ples usar adminim ${min} caracteres.";

  static String m73(mxid) => "To deve esser ${mxid}";
