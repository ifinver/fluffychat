...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(username, targetName) => "${username} đã cấm ${targetName}";

  static String m8(username) => "${username} đã thay đổi ảnh phòng chat";
  ...
  static String m20(username) => "${username} đã đổi địa chỉ phòng chat";

  static String m21(username) => "${username} đã thay đổi đường dẫn mời";

  static String m23(error) => "Không thể giải mã tin nhắn: ${error}";

  static String m25(count) => "${count} thành viên";

  static String m26(username) => "${username} đã tạo cuộc trò chuyện";
